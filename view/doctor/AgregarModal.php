					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group form-group-default">
								...
								<input name="dnidoc" required="" type="text" class="form-control" maxlength="8" placeholder="Ingrese Cedula" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
							</div>
						</div>
